@extends('layouts.app')
@section('title', 'Perbarui Jenis Guru')
@section('content')
<!-- Start Content-->
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Perbarui Jenis Guru</li>
                    </ol>
                </div>
                <h4 class="page-title">Perbarui Data Jenis Guru</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('jenisGuru.update', $jenisGuru->id)}}" method="post">
                        @csrf @method('patch')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="title" name="title"
                                ...
                                placeholder="Masukan Nama Jenis Guru" value="{{$jenisGuru->title}}">
                            @error('title')
