                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="nip" name="nip"
                                        ...
                                        placeholder="Masukan NIP" value="{{old('nip', $tendik->nip)}}" required>
                                    @error('nip')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
...
{{-- <div class="col-md-6 mt-1 mb-3">
    ...
    <div class="d-flex flex-row">
        <div class="form-check">
            <input type="radio" id="jenis_kelamin" name="jenis_kelamin" class="form-check-input" value="P" {{
                ($tendik->jenis_kelamin == "P") ?
            "checked" : "" }}>
            <label class="form-check-label" for="jenis_kelamin">Perempuan</label>
        </div>
        &nbsp;
        <div class="form-check">
            <input type="radio" id="jenis_kelamin" name="jenis_kelamin" class="form-check-input" value="L" {{
...
<div class="col-md-6 mt-1 mb-3">
    ...
    <div class="d-flex flex-row">
        <div class="form-check">
            <input type="radio" id="pendidikan_linear" name="pendidikan_linear" class="form-check-input" value="1" {{
                ($tendik->pendidikan_linear ==
            TRUE) ?
            "checked" : "" }}>
            <label class="form-check-label" for="pendidikan_linear" {{ ($tendik->pendidikan_linear == '0') ?
                "checked" : "" }}>Linear</label>
        </div>
        &nbsp;
        <div class="form-check">
            <input type="radio" id="pendidikan_linear" name="pendidikan_linear" class="form-check-input" value="0" {{
                ($tendik->pendidikan_linear ==
            FALSE)
            ?
            "checked" : "" }}>
